      ...
      <div class="bingo-discounts-recalculate__wrapper">
        ...
        <div class="bingo-discounts-recalculate__parameters parameters">
          <div class="parameters__wrapper">
            ...
            <input type="number" :value="recalc_data.expected_budget" readonly><span>бобров</span>
            <input type="number" :value="recalc_data.expected_budget * this.course().bobr_to_rub" readonly><span>рублей</span>
            <h2>Охват аудитории:</h2>
            <input type="number" :value="recalc_data.total_participants" readonly><span>участников</span>
          </div>
        </div>
