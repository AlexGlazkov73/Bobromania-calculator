      ...
      <div class="bingo-discounts-input__wrapper">
        <div class="bingo-discounts-input__left">
          <div class="bingo-discounts-input__constants constants">
            ...
            <input type="number" v-model="form_input_data.budget" min="1" max="9999999999" step="1" placeholder="Бюджет" required>
            <input type="number" v-model="form_input_data.lucky_participants" min="1" max="9999999999" step="1" placeholder="Количество" required>
          </div>
        ...
        <div class="bingo-discounts-input__right">
          <div class="bingo-discounts-input__probability probability">
            ...
            <input type="number" placeholder="Бюджет" value="1" min="0.01" max="1" step="0.01" required>
          </div>
